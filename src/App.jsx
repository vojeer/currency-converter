...
function App() {
  const backGroundImage = 'https://i.pinimg.com/originals/94/7c/e6/947ce66baf30af28754c4171f9a54e14.png'
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://flowbite.com/" className="flex items-center">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Wazirx Currency Converter</span>
          </a>
